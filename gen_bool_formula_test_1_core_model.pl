...
%
formula_generator_bool_conds(BoolParams, ColSetsBool, ShiftBool, t(_NbUnary,_NbBinary,_NbTernary,_AdjustMaxOccAttrToOne), BoolConds) :-
...
formula_generator_bool_cond1(Oplus, Negated, NbTerms, MandatoryAttr, BoolOnly, UseMods, MinAttrs, MaxAttrs, ShiftedBoolAttrs,
                             _ColSetsBool, Cond, CondRestriction, LogRes, CreatedCond, CondB, LogCondB, LogCondBool) :-
