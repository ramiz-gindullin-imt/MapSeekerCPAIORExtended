...
gen_options_lists_by_type(CondBool, KindCombi, col(Table,OutputCol), _Kind, Mode, OptionsBoolCond, _PrevInputParams, InputParams, ForceToUseOnlySmallFd, ListsOptions) :-
